...
@section('content')
    ...
    @section('homePage')
        <!-- component -->
        <form action="/dashboard/services/{{ $service->id }}/edit" method="post">
            @method('put')
            @csrf
                ...
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            id="grid-first-name" type="text" name="name" value="{{ $service->name }}">
                        @error('name')
                    ...
                    <div class="md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            id="time" type="number" name="time" value="{{ $service->time }}">
                        @error('time')
                            <span class="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                {{ $message }}
                            </span>
