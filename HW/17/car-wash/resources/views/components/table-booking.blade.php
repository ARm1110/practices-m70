<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <form action="/dashboard/booking/filter" method="post" class="">
        @csrf
        @method('put')
            ...
            <div class="">
                <div class="flex items-center border-b-2 border-gray-200 py-2">
                    <input
                        ...
                        type="text" name="username" placeholder="username..." aria-label="Full name">
                </div>
            </div>
            <div class="  ">
                <div class="flex items-center border-b-2 border-gray-200 py-2">
                    <input
                        class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                        type="text" name="service" placeholder="service..." aria-label="Full name">
                </div>
            </div>
            <div class="  ">
                <div class="flex items-center border-b-2 border-gray-200 py-2">
                    <input
                        class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                        type="text" name="station" placeholder="station..." aria-label="Full name">
                </div>
            </div>
            <div class="  ">
                <div class="flex items-center border-b-2 border-gray-200 py-2">
                    <input
                        class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                        type="text" name="token" placeholder="token..." aria-label="Full name">
                </div>
            </div>
            <div class=" ">
