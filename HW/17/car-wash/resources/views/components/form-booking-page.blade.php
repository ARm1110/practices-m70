...
<div role="alert" id="error" class=" absolute top-4  opacity-90 right-0 w-96 hidden  ">
    ...
    <div id="massage" class="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
...
<div role="alert" id="success" class=" absolute top-4  opacity-90 right-0 w-96 hidden  ">
    ...
    <div id="massage" class="border border-t-0 border-green-400 rounded-b bg-green-100 px-4 py-3 text-green-700">
