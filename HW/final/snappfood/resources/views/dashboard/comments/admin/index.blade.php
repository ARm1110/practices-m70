            ...
            <x-slot name="body">
                @foreach ($data['comments'] as $items)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            @if ($items->is_verified == 1)
                                <span class="text-green-500">Accepted</span>
                            @else
                                <span class="text-red-500">pending</span>
                            @endif
                        <td class="px-6 py-4">
                            <a href="{{ route('dashboard.admin.comment.approve', $items->id) }}" class="text-green-500">
                        ...
                        <td class="px-6 py-4">
                            <form action="">
                                <a href="{{ route('dashboard.admin.comment.reject', $items->id) }}" class="text-red-500">
